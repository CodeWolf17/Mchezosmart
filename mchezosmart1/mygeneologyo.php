  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round">
        <div class="w3-white">
          ...
          <a href="mygeneologyo.php" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class=" fa fa-user  w3-text-green fa-fw w3-margin-right"></i> My Geneology</a>
    ...
    <div class="w3-col m9">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin radie contabee"><br>
        <div align="center"><font color="white" size="6" type="comic sans">My Geneology.</font></div>
