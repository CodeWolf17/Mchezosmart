...
if(isset($_POST['Submit']))
{
  ...
  $uid=intval($_GET['uid']);
$query=mysqli_query($con,"update users set sponsor='$sponsor', fname='$fname' ,lname='$lname', email='$email', activate='$activate', password='$password', bdate='$bdate', country='$country', region='$region', contactno='$contact' where id='$uid'");
				...
				<div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                           ...
                           <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Sponsor Name</label>
                           <div class="col-sm-10">
                          ...
                          <div class="form-group">
                          <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">activate</label>
                          <div class="col-sm-10">
                              <input type="text" class="form-control" name="activate" value="<?php echo $row['activate'];?>" >
                          </div>
                      </div>
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control" name="bdate" value="<?php echo $row['bdate'];?>" >
                  </div>
              </div>
